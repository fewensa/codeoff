...
impl StateStore {
  ...
  pub async fn claim_next_scheduled_delivery(
    ...
    transaction.commit().await.map_err(scheduler_error)?;
    Ok(Some(ClaimedScheduledDelivery { binding, payload }))
  }
