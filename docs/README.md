...
Purpose: route Codeoff documentation by responsibility.
Read this when looking for project standards or the current channel gateway design.
This does not replace the documents it links to.

## Engineering

- `engineering/coding-standards.md`: project-wide formatting, Rust workspace, module, file size, and test placement rules.
